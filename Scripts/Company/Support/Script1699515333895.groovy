...
WebUI.click(findTestObject('Page_OrangeHRM/span_Paul CollingsBrenna'))

WebUI.click(findTestObject('Page_OrangeHRM/a_Support'))

WebUI.verifyTextPresent('Getting Started with OrangeHRM', false)
