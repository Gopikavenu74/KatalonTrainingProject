...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Select'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_Employee Id_oxd-switch-input oxd-switch-input--active --label-right'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Search'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h5_Leave List'))
