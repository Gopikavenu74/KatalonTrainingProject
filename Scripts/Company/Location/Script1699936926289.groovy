...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Organization'))
...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), '12481')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_-- Select --_oxd-icon bi-caret-down-fill oxd-select-text--arrow'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), '123467899')
