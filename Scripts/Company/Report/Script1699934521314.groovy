...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Reports'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Add'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), 'Project')
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/h6_Display Fields'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/h6_Display Fields'), 'Display Fields')
